...
return require("lazy").setup({ -- Packer can manage itself
    ...
    config = function()
      require("filetype").setup({
        overrides = {
          ...
          function_literal = { Brewfile = function()
            vim.cmd("syntax off")
          end },
          function_complex = {
  ...
  }, "telescope-ghq.nvim", "telescope-z.nvim", "telescope-frecency.nvim"
  ...
  "hrsh7th/nvim-cmp",
  dependencies = {
    { "hrsh7th/cmp-buffer" }, { "hrsh7th/cmp-emoji" }, { "hrsh7th/cmp-nvim-lsp" },
    { "hrsh7th/cmp-path" }, { "hrsh7th/cmp-cmdline" },
    { "hrsh7th/cmp-nvim-lsp-signature-help" }, { "hrsh7th/cmp-nvim-lua" },
    { "hrsh7th/cmp-emoji" }, { "hrsh7th/cmp-nvim-lsp-document-symbol" }, {
    "hrsh7th/cmp-vsnip",
    dependencies = { "vim-vsnip", "cmp-nvim-lsp-document-symbol" }
  },
    {
      "onsails/lspkind.nvim",
      config = function() require("plugconfig/lspkind") end
    }, -- {
    -- 	"tzachar/cmp-tabnine",
    -- 	config = function()
    ...
    config = function() require("plugconfig/mason-lsp") end
  }, { "williamboman/mason.nvim" }, {
    "hrsh7th/vim-vsnip",
    config = function() require("plugconfig/vsnip") end,
  ...
  event = { "UIEnter" },
  config = function() require("plugconfig/nvim_cmp") end
}, {
  "phaazon/hop.nvim",
  branch = "v2", -- optional but strongly recommended
  event = "VimEnter",
  config = function() require("plugconfig/hop") end
}, {
  ...
  event = "VimEnter",
  config = function() require("plugconfig/nvim-tree") end
}, {
  "t9md/vim-quickhl",
  event = "VimEnter",
  config = function() require("plugconfig/vim_quichl") end
}, {
  "terryma/vim-expand-region",
  event = "VimEnter",
  config = function() require("plugconfig/vim_expand_region") end
  ...
  dependencies = "kyazdani42/nvim-web-devicons",
  event = "VimEnter",
  config = function() require("plugconfig/luatab") end
}, --
  -- {
  --   "vim-jp/vimdoc-ja",
  --   event = "VimEnter",
  ...
  -- terminal
  {
    ...
    version = "*",
    event = "VimEnter",
    config = function() require("plugconfig/toggleterm") end
  }, {
...
}, -- git
  {
    ...
    event = "VimEnter",
    config = function() require("plugconfig/lazygit") end
  }, {
  ...
  -- },
  {
    ...
    event = "VimEnter",
    config = function() require("plugconfig/indent_blankline") end
  }, -- treesitter settins
  {
    ...
    dependencies = {
      ...
      config = function() require("plugconfig/treesitter-context") end
  ...
  dependencies = {
    "kyazdani42/nvim-web-devicons", "justinhj/battery.nvim",
    "nvim-lua/plenary.nvim"
  },
  event = "VimEnter",
  config = function() require("plugconfig/lualine") end
}, {
  "echasnovski/mini.nvim",
  branch = "stable",
  event = "VimEnter",
  config = function() require("plugconfig/mini") end
}, -- {
  ...
  -- },
  {
    ...
    -- keys = { ":CccPick<cr>" },
    config = function() require("plugconfig/ccc-nvim") end
  }, { "nvim-lua/plenary.nvim" }, {
  "folke/todo-comments.nvim",
  dependencies = "nvim-lua/plenary.nvim",
  event = "VimEnter",
  config = function() require("plugconfig/todo-comments") end
}, {
  "ibhagwan/smartyank.nvim",
  event = "VimEnter",
  config = function() require("plugconfig/smartyank") end
  ...
  -- },
  {
    ...
    onfig = function() require("plugconfig/null_ls") end
  },
  ...
  event = "InsertEnter",
  config = function() require("presence"):setup({ auto_update = false }) end
}, {

  "folke/noice.nvim",
  config = function() require("plugconfig/noice") end,
  event = "VimEnter",
  dependencies = {
    "MunifTanjim/nui.nvim", {
    "rcarriga/nvim-notify",
    config = function() require("plugconfig/nvim-notify") end
  }
  }
}, {
  ...
  config = function()
    ...
    vim.api.nvim_set_keymap("", "<Leader>gg", "<Cmd>Select2Browser<CR>",
      { noremap = true, silent = true })
  end
}, {
  "jackMort/ChatGPT.nvim",
  event = "VimEnter",
  config = function() require("plugconfig/chat-gpt-nvim") end,
  dependencies = {
